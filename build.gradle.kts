...
plugins {
  ...
  // Even though this is apply: false, it places the latest Kotlin on the
  // classpath. Without this line, the kotlin-stdlib will be whatever is shipped
  // with AGP, which can then lead to odd build errors in applications:
  //
  // ===
  // e: Class 'com.pyamsoft.cachify.Cached' was compiled by a pre-release version of
  // Kotlin and cannot be loaded by this version of the compiler.
  // ===
  //
...
subprojects {
  ...
  afterEvaluate {
    extensions.configure<PublishingExtension> {
      publications {
        create<MavenPublication>("Cachify") {
